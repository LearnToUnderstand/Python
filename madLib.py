...
import datetime, sys, time, multiProgram
...
def madLib():
    ...
    choice1= input("Hello!  would you like to create a story together? \n Type y for yes, or n for no.\n ")

    if choice1 == "yeppers" or "Yeppers":
        print("Great!  Let's get started!")
        countdown()
    elif choice1 == "n" or "N":
        no = input("Ok, then.  Press 1 to return to the main menu, or press 2 to exit the program completely:  ")
        no = int(no)
        if no == 1:
